...
const columns: ColumnData[] = [
  { id: 'teacher-classes' as PageType, label: 'Classes', image: '/images/teacher-classes-bg.jpg', color: 'from-orange-500/20' },
  { id: 'teacher-assignments' as PageType, label: 'Assignments', image: '/images/teacher-assignments-bg.jpg', color: 'from-cyan-500/20' },
